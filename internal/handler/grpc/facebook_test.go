...
type mockFacebookService struct {
	createFn func(ctx context.Context, req model.CreateFacebook) (*model.FacebookGate, error)
	getFn    func(ctx context.Context, id string) (*model.FacebookGate, error)
	updateFn func(ctx context.Context, req model.UpdateFacebook) (*model.FacebookGate, error)
	deleteFn func(ctx context.Context, id string) (*model.FacebookGate, error)
}

func (m *mockFacebookService) CreateGate(ctx context.Context, req model.CreateFacebook) (*model.FacebookGate, error) {
	return m.createFn(ctx, req)
}
func (m *mockFacebookService) GetGate(ctx context.Context, id string) (*model.FacebookGate, error) {
	return m.getFn(ctx, id)
}
func (m *mockFacebookService) UpdateGate(ctx context.Context, req model.UpdateFacebook) (*model.FacebookGate, error) {
	return m.updateFn(ctx, req)
}
func (m *mockFacebookService) DeleteGate(ctx context.Context, id string) (*model.FacebookGate, error) {
	return m.deleteFn(ctx, id)
}

// -- helpers --

func stubGate() *model.FacebookGate {
...
func TestCreateFacebookGate_Success(t *testing.T) {
	svc := &mockFacebookService{
		createFn: func(_ context.Context, req model.CreateFacebook) (*model.FacebookGate, error) {
...
func TestCreateFacebookGate_ServiceError(t *testing.T) {
	svc := &mockFacebookService{
		createFn: func(_ context.Context, _ model.CreateFacebook) (*model.FacebookGate, error) {
...
func TestGetFacebookGate_Success(t *testing.T) {
	svc := &mockFacebookService{
		getFn: func(_ context.Context, id string) (*model.FacebookGate, error) {
			if id != "gate-1" {
...
func TestGetFacebookGate_NotFound(t *testing.T) {
	svc := &mockFacebookService{
		getFn: func(_ context.Context, _ string) (*model.FacebookGate, error) {
...
func TestUpdateFacebookGate_Success(t *testing.T) {
	svc := &mockFacebookService{
		updateFn: func(_ context.Context, req model.UpdateFacebook) (*model.FacebookGate, error) {
			if req.ID != "gate-1" {
...
func TestUpdateFacebookGate_ServiceError(t *testing.T) {
	svc := &mockFacebookService{
		updateFn: func(_ context.Context, _ model.UpdateFacebook) (*model.FacebookGate, error) {
...
func TestDeleteFacebookGate_Success(t *testing.T) {
	svc := &mockFacebookService{
		deleteFn: func(_ context.Context, id string) (*model.FacebookGate, error) {
			if id != "gate-1" {
				t.Errorf("unexpected id: %s", id)
			}
			return stubGate(), nil
...
func TestDeleteFacebookGate_ServiceError(t *testing.T) {
	svc := &mockFacebookService{
		deleteFn: func(_ context.Context, _ string) (*model.FacebookGate, error) {
