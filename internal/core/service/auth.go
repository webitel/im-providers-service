...
type Auther interface {
	Inspect(ctx context.Context) (*sharedmodel.AuthContact, error)
}
...
func (s *AuthService) Inspect(ctx context.Context) (*sharedmodel.AuthContact, error) {
	...
	return &sharedmodel.AuthContact{
