...
type MediaManager interface {
	UploadFile(ctx context.Context, req model.UploadRequest, body io.Reader) (model.UploadResponse, error)
}
...
func (s *MediaService) UploadFile(ctx context.Context, req model.UploadRequest, body io.Reader) (model.UploadResponse, error) {
	if body == nil {
		return model.UploadResponse{}, errors.InvalidArgument("body reader is nil", errors.WithID("media.service.upload_file"))
	}
	...
	if err != nil {
		return model.UploadResponse{}, errors.Internal("failed to open storage stream", errors.WithCause(err), errors.WithID("media.service.upload_file"))
	}
	...
	if err != nil {
		return model.UploadResponse{}, errors.Wrap(err, errors.WithID("media.service.upload_file"))
	}
